...
public class LocalDriverFactory {
    public static WebDriver createInstance(String browserName) {
        ...
        switch (Browser.valueOf(browserName.toUpperCase())) {
            case FIREFOX:
            	System.setProperty("webdriver.gecko.driver", "/Users/adminibm/Desktop/ChromeDriver/geckodriver");
            ...
            case IE:
                ...
                break;
            case CHROME:
            	System.setProperty("webdriver.chrome.driver", "/Users/adminibm/Desktop/ChromeDriver/chromedriver");
