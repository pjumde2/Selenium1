...
public class RemoveSupplier extends LaunchApplication {
	
	public static String Removesupplier(HashMap<String, String> hm)
	{
      ...
      try{
			...
			String screenshot="RemoveSupplier";
			...
			Select supplier = new Select(driver.findElement(By.id("allSupplierComboRemoveID")));
