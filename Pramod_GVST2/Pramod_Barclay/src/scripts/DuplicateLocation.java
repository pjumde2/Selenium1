...
public class DuplicateLocation extends LaunchApplication {
	
	public static String Duplicatelocation(HashMap<String, String> hm)
	{
		...
		try{
			...
			String screenshot="DuplicateLocation";
			...
			market.selectByVisibleText(hm.get("New_Markets"));
			
			driver.findElement(By.xpath("//div[@id='page-body_undefined']/div/div[3]//div[@id='grid_column_5_clps_div']")).click();
			
			
			driver.findElement(By.id("insertLocation__locationName")).sendKeys(hm.get("New_Location_Name"));
