...
public class ManageTier extends LaunchApplication {
	
	public static String Managetier(HashMap<String, String> hm)
	{
    ...
    try{			
			...
			driver.findElement(By.xpath("//p[.='Manage Tier']")).click();
