...
public class RemoveZone extends LaunchApplication {
	
	public static String Removezone(HashMap<String, String> hm)
	{
       ...
       try{			
			...
			driver.findElement(By.xpath("//div[@id='page-body_undefined']/div/div[3]/div/div[3]/div/div//div[@id='grid_column_6_clps_div']")).click();
			driver.findElement(By.id("element_button_4")).click();
