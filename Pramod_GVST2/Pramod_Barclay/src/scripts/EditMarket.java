...
public class EditMarket extends LaunchApplication {
	...
	public static String Editmarket(HashMap<String, String> hm)
	{
		try{
			...
			if(hm.containsKey("New_Market_Name")&& !hm.get("New_Market_Name").equalsIgnoreCase("null"))
			{
			...
			if(hm.containsKey("New_Currency")&& !hm.get("New_Currency").equalsIgnoreCase("null"))
			{
			...
			if(hm.containsKey("New_Local_Factor")&& !hm.get("New_Local_Factor").equalsIgnoreCase("null"))
			{
				driver.findElement(By.xpath("//*[@id='market__localFactor']")).clear();
				driver.findElement(By.xpath("//*[@id='market__localFactor']")).sendKeys(hm.get("New_Local_Factor"));
				System.out.println("New_Local_Factor:  "+hm.get("New_Local_Factor"));
				
			}
			
			if(hm.containsKey("New_National_Factor")&& !hm.get("New_National_Factor").equalsIgnoreCase("null"))
			{
				driver.findElement(By.xpath("//*[@id='market__nationalFactor']")).clear();
				driver.findElement(By.xpath("//*[@id='market__nationalFactor']")).sendKeys(hm.get("New_National_Factor"));
				System.out.println("New_National_Factor:  "+hm.get("New_National_Factor"));
				
			}
			
			if(hm.containsKey("New_Cache_Retention_Period")&& !hm.get("New_Cache_Retention_Period").equalsIgnoreCase("null"))
			{
				driver.findElement(By.id("market__cacheRetentionPeriod")).clear();
				driver.findElement(By.id("market__cacheRetentionPeriod")).sendKeys(hm.get("New_Cache_Retention_Period"));
				System.out.println("New_Cache_Retention_Period:  "+hm.get("New_Cache_Retention_Period"));
